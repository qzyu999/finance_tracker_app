...
ROBINHOOHD_TRADITIONAL_IRA_WORKSHEET_NAME='robinhood_traditional_ira_modified'
...
robinhood_traditional_ira_worksheet = finance_tracker_db_spreadsheet.worksheet(ROBINHOOHD_TRADITIONAL_IRA_WORKSHEET_NAME)
